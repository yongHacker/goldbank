...
class Tree {
    ...
    public function get_child2($myid) {
        ...
        return $newarr ? array_merge($newarr) : false;
    }
	/**
     * 得到子级数组
     * @param int
     ...
     * @return string
     */
    public function get_tree_array2($myid, $str, $sid = 0, $adds = '', $str_group = '') {
        $retarray = array();
        //一级栏目数组
        ...
        if (is_array($child)) {
            ...
            foreach ($child as $id => $value) {
                ...
                $retarray[$value['id']]["child"] = $this->get_tree_array2($id, '');
            }
        }
        return array_merge($retarray);
    }
