...
class BMergeDetailModel extends BCommonModel{
    ...
    public function getList_detail($where){
        $condition=array("bmerge_detail.deleted"=>0);
        if($where){
        ...
        $detail_data=$this->alias("bmerge_detail")->getList($condition,$field,$limit="",$join,$order='bmerge_detail.id desc');
    ...
    public function new_getList_detail($where){
        ...
        $join="left join ".DB_PRE."b_product bproduct on bproduct.id=bmerge_detail.p_id";
        $join.=" left join ".DB_PRE."b_allot ballot on ballot.id=bmerge_detail.allot_id";
