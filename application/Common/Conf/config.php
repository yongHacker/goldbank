...
$_web_prefix = (strpos($_SERVER['SERVER_NAME'], 'm.gold-banker.cn') === false && $_SERVER['SERVER_PORT'] == 7071) ? '测试-' : '';

$configs= array(
    'WEB_PREFIX'=> $_web_prefix,
        ...
        'MODULE_ALLOW_LIST'  => array('Admin','Portal','Asset','Api','User','Wx','Comment','Qiushi','Tpl','Topic','Install','Bug','Better','Pay','Cas','Business','System','Client'),
        'TMPL_DETECT_THEME'     => false,       // 自动侦测模板主题
        'TMPL_TEMPLATE_SUFFIX'  => '.html',     // 默认模板文件后缀
        'DEFAULT_MODULE'        =>  'Business',  // 默认模块
	    ...
	    'MAX_FILE_COUNT'=>1000,  		//目录下最大文件数，用于商品图片保存设置
	 	'DEFAULT_GOODS_PIC'     =>    __ROOT__.'/public/images/business/huise.png',
