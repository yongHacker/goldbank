...
class BSellDetailModel extends BCommonModel{
    ...
    public function getList_detail($sell_id){
        if($sell_id){
            $condition=array("bselldetail.sell_id"=>$sell_id,'bselldetail.deleted'=>0);
        }else{
        ...
        $field="bselldetail.*,bselldetail.sell_fee detail_sell_fee,bproduct.type,bproduct.product_code,bproduct.goods_id";
