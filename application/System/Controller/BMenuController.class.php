...
class BMenuController extends SystembaseController {
    ...
    public function index() {
    	session('system_bmenu_index','BMenu/index');
    ...
    public function lists(){
    	session('system_amenu_index','BMenu/lists');
    	...
    	if (IS_POST) {
    		if ($this->menu_model->create()!==false) {
    			if ($this->menu_model->add()!==false) {
    				...
    				$session_system_amenu_index=session('system_bmenu_index');
