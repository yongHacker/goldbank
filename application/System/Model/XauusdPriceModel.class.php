...
class XauusdPriceModel extends ACommonModel{
	protected $kjjb_market,$kjjb,$table_pre;
	protected $connect;
	public function __construct(){
		$this->connect=C("JJH_DB");
		$this->table_pre="xauusd_price_";
		...
		if(!$this->kjjb_market){
			$sql="CREATE TABLE IF NOT EXISTS `".$tablename."` (
			 `id` int(11) NOT NULL AUTO_INCREMENT,
			  ...
			  PRIMARY KEY (`id`)
			) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='现货黄金行情表';";
	...
	public function insert($data){
		...
		$data['exchange_price']=$g_data[$xhhj_key]['q63'];
