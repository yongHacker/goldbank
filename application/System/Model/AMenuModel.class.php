...
class AMenuModel extends ACommonModel{
    //自动验证
    protected $_validate = array(
        ...
        array('model', 'require', '控制器不能为空！', 1, 'regex', CommonModel:: MODEL_BOTH ),
    ...
    public function admin_menu($parentid, $with_self = false) {
        ...
        foreach ($result as $v) {
            ...
            if (preg_match('/^public_/', $action)) {
                ...
                if ( sp_auth_check(sp_get_current_system_id(),$rule_name,"or","a")){
                    $array[] = $v;
                }
