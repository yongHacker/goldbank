...
class Au9999PriceModel extends ACommonModel{
	protected $kjjb_market,$kjjb,$table_pre;
	protected $connect;
	public function __construct(){
		$this->connect=C("JJH_DB");
		$this->table_pre="au9999_price_";
		...
		if(!$this->kjjb_market){
			$sql="CREATE TABLE IF NOT EXISTS `".$tablename."` (
			 `id` int(11) NOT NULL AUTO_INCREMENT,
			  ...
			  PRIMARY KEY (`id`)
			) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='上海au9999行情表';";
	...
	public function export_csv($where, $field, $join, $page = 1){
		...
		if($data_list){
			...
			header("Content-Disposition: attachment; filename=上海au9999行情.csv");
