...
// 添加一行退货详情
function _add_row(detail_id, product_id, product_pic, goods_name, goods_code, product_code, p_total_weight, purity, p_gold_weight, sell_feemode, detail_sell_fee, gold_price, sell_price, discount_price, actual_price, sell_pricemode){
	if (product_pic == null) {
