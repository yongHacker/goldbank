    ...
    $(".baocun").click(function(){
        ...
        $.ajax({
            url: API_URL+"&m=BAllot&a=edit",
            type: 'post',
            async: false,
            data: {__hash__:__hash__,add_status:add_status,trance_time:trance_time,comment:comment,allocationid:allocationid,store:store,order:eval(names),all_products:eval(all_products)},
            beforeSend:function(){
                $("#baocun").text("保存中...");
    ...
    function del2_input(){
        ...
        $(".del2").each(function(){
            ...
            $(this).click(function(){
                ...
                $.ajax({
                    url: API_URL+"&m=BAllot&a=detail_delete",
                    type: 'post',
                    async: false,
